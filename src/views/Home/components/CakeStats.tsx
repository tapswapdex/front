...
import { Card, CardBody, Heading, LinkExternal, Text } from 'tapswap-uikit'
  ...
  return (
    ...
    >
      <CardBody>
        ...
        <Row>
          <Text fontSize="14px">
            {TranslateString(538, 'TAPS burnt by TapSwaps')}{' '}
          ...
          <LinkExternal href="https://bscscan.com/token/0x56eab07247e3e6404ac90140F20bba61375d5C3C?a=0x000000000000000000000000000000000000dead">
            <CardValue fontSize="14px" value={getBalanceNumber(burnedBalance)} decimals={0} />
          </LinkExternal>
        </Row>
        <Row>
          <Text fontSize="14px">{TranslateString(540, 'New TAPS/block')}</Text>
