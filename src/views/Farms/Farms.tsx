...
const data = {
  ...
  rows: [
    ...
    // },
    {
      ...
      content: `These farms use liquidities from the <strong>P</strong>an<strong>C</strong>ake<strong>S</strong>wap DEX. TapSwap keep these farms available to be fair with users who paid deposit fees to enter into. To provide LP to these farms, you need to use PanCakeSwap DEX interface by following <a href="https://swap.tapswap.money/#/swap?inputCurrency=0xe9e7cea3dedca5984780bafc599bd69add087d56&outputCurrency=0x56eab07247e3e6404ac90140F20bba61375d5C3C" target="_blank" style="color: orange;font-weight: bold">this link</a>. All futures farms created on TapSwap will use APE LP. Read more about the TapSwap & ApeSwap partnership in this <a href="https://tapswapmoneydex.medium.com/partnership-with-apeswap-finance-c1dd2dd44eee" target="_blank" style="color: orange;font-weight: bold">blog post</a>.`,
    },
    {
