...
import { Heading, Text, Flex, ChevronRightIcon } from 'tapswap-uikit'
  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'TapSwap Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'TapSwap Collectibles are special ERC-721 NFTs that can be used on the TapSwap platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved TapSwap Collectibles won't be shown here.",
        )}
      </Text>
